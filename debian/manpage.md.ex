...
srain - program to do something

# SYNOPSIS

**srain** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**srain** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **srain** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**srain** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    srain. See **foo.conf**(5) for further details.
...
**srain** provides some return codes, that can be used in scripts:
...
Copyright © 2007 Anuradha Weeraman
